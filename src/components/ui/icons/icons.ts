export const Icons = {
  groups: {
    ...
    class: 'mt-1 h-8 w-8 shrink-0 fill-orange-400',
    width: 48,
    height: 48,
  ...
  camera: {
    ...
    class: 'h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-orange-700 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  tools: {
    ...
    class:
      'mt-2 h-6 w-6 shrink-0 fill-neutral-700 hs-tab-active:fill-orange-400 md:h-7 md:w-7',
    width: 48,
    height: 48,
    viewBox: '0 -960 960 960',
  },
  ...
  house: {
    ...
    class:
      'h-6 w-6 shrink-0 text-neutral-700 hs-tab-active:text-orange-700 md:h-7 md:w-7',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  arrowUp: {
    ...
    class: 'h-5 w-5 shrink-0 text-orange-700',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  accordionNotActive: {
    ...
    class:
      'block h-5 w-5 shrink-0 text-neutral-600 group-hover:text-neutral-500 hs-accordion-active:hidden',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  accordionActive: {
    ...
    class:
      'hidden h-5 w-5 shrink-0 text-neutral-600 group-hover:text-neutral-500 hs-accordion-active:block',
    width: 24,
    height: 24,
    viewBox: '0 0 24 24',
    fill: 'none',
  ...
  question: {
    ...
    class: 'mt-1.5 h-6 w-6 shrink-0 text-neutral-600',
    viewBox: '0 0 24 24',
    fill: 'none',
    strokeWidth: '1.5',
    strokeLinecap: 'round',
